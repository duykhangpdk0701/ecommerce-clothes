...
Route::group(['prefix' => 'item-color'], function () {
    ...
    Route::put('/{itemColor}', [ItemColorController::class, 'update'])->name('admin.item-color.update');
    Route::delete('/{itemColor}', [ItemColorController::class, 'destroy'])->name('admin.item-color.destroy');
});
