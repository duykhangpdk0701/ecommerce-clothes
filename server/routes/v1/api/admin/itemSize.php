...
Route::group(['prefix' => 'item-size'], function () {
    ...
    Route::put('/{itemSize}', [ItemSizeController::class, 'update'])->name('admin.item-size.update');
    Route::delete('/{itemSize}', [ItemSizeController::class, 'destroy'])->name('admin.item-size.destroy');
});
