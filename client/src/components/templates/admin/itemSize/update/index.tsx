...
interface IUpdateItemSizeTemplate {
  control: Control<IUpdateItemSizeParams, any>;
  handleSubmit: UseFormHandleSubmit<IUpdateItemSizeParams>;
  onSubmit: SubmitHandler<IUpdateItemSizeParams>;
  errors: FieldErrors<IUpdateItemSizeParams>;
  isLoading: boolean;
  errorResMessage: string;
  itemCategory?: ICategory[];
}

const UpdateItemSizeTemplate: FC<IUpdateItemSizeTemplate> = (props) => {
  const {
    control,
    handleSubmit,
    onSubmit,
...
export default UpdateItemSizeTemplate;
